...
*********************************************************************/
	public static void drawHex(int i, int j, Graphics2D g2) {
		...
		Polygon poly = hex(x,y);
                ...
                Color smokeyColor = new Color(255, 255,255, 255);
...
*****************************************************************************/
	public static void fillHex(Unite pers,int i, int j, Graphics2D g2) {
		char c='o';
		int x = i * (s+t);
		int y = j * h + (i%2) * h/2;
                      ...
                      // System.out.println("i et j "+i+" "+ j);
                        //System.out.println(pers.getImgUnite());
                        
                        g2.drawImage(pers.getImgUnite(), x+r+BORDERS-20, y+r+BORDERS-20, (null));
